    ...
    <footer className="bg-primary text-primary-foreground overflow-hidden">
      <div className="container px-4 sm:px-6 py-8 sm:py-10 lg:py-16">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-12">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-[11px] sm:text-xs lg:text-sm font-bold uppercase tracking-wider mb-3 sm:mb-4 lg:mb-6">Links Rápidos</h4>
            <ul className="flex flex-col gap-1.5 sm:gap-2 lg:gap-3">
              <li>
                <a href="/" className="text-[11px] sm:text-xs lg:text-sm text-primary-foreground/80 hover:text-primary-foreground transition-colors">
                  Sobre Nós
                </a>
              </li>
              <li>
                <a href="/#produtos" className="text-[11px] sm:text-xs lg:text-sm text-primary-foreground/80 hover:text-primary-foreground transition-colors">
                  Produtos
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="/#contato" className="text-[11px] sm:text-xs lg:text-sm text-primary-foreground/80 hover:text-primary-foreground transition-colors">
                  Contato
                </a>
              </li>
              <li>
                <Link to="/rastreio" className="text-[11px] sm:text-xs lg:text-sm text-primary-foreground/80 hover:text-primary-foreground transition-colors flex items-center gap-1.5 sm:gap-2">
          ...
          {/* Categories */}
          <div>
            <h4 className="text-[11px] sm:text-xs lg:text-sm font-bold uppercase tracking-wider mb-3 sm:mb-4 lg:mb-6">Categorias</h4>
            <ul className="flex flex-col gap-1.5 sm:gap-2 lg:gap-3">
              <li>
                <a href="/#produtos" className="text-[11px] sm:text-xs lg:text-sm text-primary-foreground/80 hover:text-primary-foreground transition-colors">
                  Shorts
