        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6">
          {categories.map((category, index) => (
            ...
            >
              ...
              {/* Default Label */}
              <div className="absolute bottom-0 left-0 right-0 p-3 sm:p-4 bg-card group-hover:opacity-0 transition-opacity duration-300">
                <h3 className="text-sm sm:text-base lg:text-lg font-bold text-foreground text-center">
                  {category.name}
                </h3>
              </div>
            </a>
