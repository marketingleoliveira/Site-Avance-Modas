  ...
  return <section className="py-20 bg-secondary">
      <div className="container">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
          {categories.map((category, index) => <a key={category.name} href={`/${category.name.toLowerCase()}`} className="group relative overflow-hidden bg-card rounded-lg hover-lift" style={{
